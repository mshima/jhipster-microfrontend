...
jest.mock('ng-jhipster/core/auth/state-storage.service');
...
import { Authority } from 'ng-jhipster/config/authority.constants';
import { StateStorageService } from 'ng-jhipster/core/auth/state-storage.service';
