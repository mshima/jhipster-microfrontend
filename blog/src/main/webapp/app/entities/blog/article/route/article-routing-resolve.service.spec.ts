...
describe('Service Tests', () => {
  describe('Article routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IArticle for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Article(id) })));
        ...
        expect(resultArticle).toEqual(new Article(123));
      });
