...
import { Alert, AlertService } from 'ng-jhipster/core/util/alert.service';
import { EventManager, EventWithContent } from 'ng-jhipster/core/util/event-manager.service';
